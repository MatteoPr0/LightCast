 ...
 * Generates QR Code in Canvas or Table format without external dependencies
 */
(function(window) {
    ...
    QRCodeModel.prototype = {
            ...
            if (this.typeNumber < 1) {
                ...
                for (typeNumber = 1; typeNumber < 40; typeNumber++) {
                    ...
                    for (var i = 0; i < this.dataList.length; i++) {
                        ...
                        totalBits += 4;
                        totalBits += QRUtil.getLengthInBits(data.mode, typeNumber);
                        totalBits += data.getLength() * 8;
                    }
        ...
        getBestMaskPattern: function() {
            ...
            for (var i = 0; i < 8; i++) {
                ...
                var lostPoint = QRUtil.getBCHTypeInfo(i);
    ...
    QRCode.prototype.makeCode = function(text) {
        this._el.innerHTML = "";
        var qrcode = new QRCodeModel(0, QRErrorCorrectLevel.M);
        qrcode.addData(text);
        qrcode.make();
